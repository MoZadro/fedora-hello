...
pipeline {
    ...
    environment {
        ...
        NAMESPACE = "test-frontend" // change
        TEAM_NAME = "test"  //svn, int, cas, ngs
        ...
        DOCKER_IMAGE = "frontend" //change (project name or something)

        TRANSCRYPT_CREDENTIALS_ID = "transcrypt-frontend" //change
